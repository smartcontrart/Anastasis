...
const fs = require('fs');
const AL = require("./ContractData/AL/CreatorALAct3.json")
const ALaddresses = AL.addresses;
var contract_address = process.env.PROD_CONTRACT_ACT3_ADDRESS;
...
module.exports = async function() {
    ...
    fs.writeFileSync('signedListAct3Creators.json', data);
}
