...
function ConnexionStatus() {
        return(
            ...
            <span id='connexion_info'><small>Minting contract address <b><a className="etherscan_link" href={"https://etherscan.io/address/"+process.env.REACT_APP_MAINNET_CONTRACT_ACT3MINT_ADDRESS}>{process.env.REACT_APP_MAINNET_CONTRACT_ACT3MINT_ADDRESS}</a></b></small></span>
            </React.Fragment>
        )
}
